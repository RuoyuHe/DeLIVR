...
IVa_path = out_path + 'results/DeLIVR_robust_test/hdl_robust_{}.txt'.format(file_num)
debug_path = out_path + 'results/debug/DeLIVR_robust_test/hdl_{}.txt'.format(file_num)
