...
stage1 <- function(gene_ind, 
  ...
  FINAL_RESULT = list(gene=gene_name,
                      ...
                      stage2_l_p = pf(tmpl$fstatistic[1],
                                      tmpl$fstatistic[2],
                                      tmpl$fstatistic[3], lower.tail = F),
                      stage2_lq_global_p = pf(tmplq$fstatistic[1],
                                              tmplq$fstatistic[2],
                                              tmplq$fstatistic[3], lower.tail = F),
                      stage2_lq_nonlinear_p = lq_nonlinear_p,
                      stage1_X1_fstat = lm_stage1_X1$fstatistic[1],
                      stage1_X1_pval = pf(lm_stage1_X1$fstatistic[1],
                                          lm_stage1_X1$fstatistic[2],
                                          lm_stage1_X1$fstatistic[3], lower.tail = F),
                      stage1_X2_fstat = lm_stage1_X2$fstatistic[1],
                      stage1_X2_pval = pf(lm_stage1_X2$fstatistic[1],
                                          lm_stage1_X2$fstatistic[2],
