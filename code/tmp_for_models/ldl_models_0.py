...
common_path = out_path + 'results/ldl/combine_p/common_{}.txt'.format(file_num)
...
for gene_ind in range(start, end):
	...
	for j in range(num_repeats):
		...
		# save model
		if True:
			rsp1.save("/home/panwei/he000176/deepRIV/UKB/models/ldl/combine_p/model_{}_{}".format(gene_ind, j))
		with open(debug_path, "a") as f:
			f.write("{}: Done\n".format(j))
	#
	...
	IVa_path = out_path + 'results/ldl/combine_p/IVa_{}.txt'.format(file_num)
