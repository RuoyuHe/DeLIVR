...
common_path = out_path + 'results/MR/ldl/' + exposure + '_common_{}.txt'.format(file_num)
IVa_path = out_path + 'results/MR/ldl/' + exposure + '_IVa_{}.txt'.format(file_num)
...
for j in range(num_params):
	...
	for k in range(j*num_repeats, (j+1)*num_repeats):
		...
		# save model
		if True:
			rsp1.save("/home/panwei/he000176/deepRIV/UKB/models/MR/ldl/" + exposure + "_{}_{}".format(j, k))
		with open(debug_path, "a") as f:
			f.write("{}: Done\n".format(k))
		#
