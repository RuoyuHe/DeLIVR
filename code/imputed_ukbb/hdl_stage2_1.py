...
r = robjects.r
r['source']('/home/panwei/he000176/deepRIV/UKB/code/hdl/imputed_combine_p/hdl_stage1_FUN_impute.R')
...
common_path = out_path + 'results/hdl/imputed_combine_p/common_{}.txt'.format(file_num)
debug_path = out_path + "results/debug/imputed_combine_p/{}.txt".format(file_num)
...
for gene_ind in range(start, end):
	...
	for j in range(num_repeats):
		...
		if IVa_pval_nonlinear[j] <= 0.05/100:
			rsp1.save("/home/panwei/he000176/deepRIV/UKB/models/hdl/imputed_combine_p/model_{}_{}".format(gene_ind, j))
		with open(debug_path, "a") as f:
			f.write("{}: Done\n".format(j))
	#
	...
	IVa_path = out_path + 'results/hdl/imputed_combine_p/IVa_{}.txt'.format(file_num)
